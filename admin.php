...
<iframe name="back" style="display:none;"></iframe>
	<div id="all">
    	<div id="title">
        <?=date("m月 d日 l")?> | 今日瀏覽: <?=$_SESSION['total']?> | 累積瀏覽: <?=q("select sum(`total`) from total")[0][0]?><span style="float:right"><a href="index.php">回首頁</a></span>       </div>
        <div id="title2">
...
?>
                    	...
                    	<div class="">
											<?
											if(!empty($_GET['do'])) include "./admin/" .$_GET['do'] .".php";
											else echo "<h1 class='ct'>請選擇管理項目</h1>";
											?>
                		                        </div>
                </div>
            </div>
